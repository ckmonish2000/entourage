...
class Loop:
    ...
    def _generate_response(self):
        ...
        while iteration < MAX_ITERATIONS:
            ...
            if has_tool_calls:
                ...
                for item in response.output.items:
                    if item.type == ItemType.FUNCTION_CALL:
                        ...
                        if args is not None:
                            ...
                            self.memory.add_message(MessageRole.DEVELOPER, f"Tool output: {tool_output}")
                ...
                if final_response:
                    self.memory.add_message(MessageRole.ASSISTANT, final_response)
                break
    ...
    def _get_chunk_item(self,chunk):
